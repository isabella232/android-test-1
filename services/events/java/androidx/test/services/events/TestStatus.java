...
public final class TestStatus implements Parcelable {
  ...
  public enum Status {
    ...
    CANCELLED,
    /**
     * This operation did not run or trigger any other operations.  If this or {@link SKIPPED} is
     * not emitted for tests that were not run, the receiver should mark them as {@link CANCELLED}
     * since the underlying test runner may have unexpectedly crashed in the middle of running these
     * tests.
     *
     ...
     * action.  An example of this would be if a test threw an
     * {@link org.junit.AssumptionViolatedException} - indicating that it should not be run.  This
     * does prevent other pre & post test operations from running.
     *
